...
function init() {
	...
	meshes[7] = matCapTest('/19.jpg', [2, 1.5, -40])
	meshes[8] = wImage('/15.jpg', [0, 0, -45])
	meshes[9] = matCapTest('/9.jpg', [-1, 3, -45])
	meshes[10] = matCapTest('/14.jpg', [-1, 1, 0])
	meshes[11] = matCapTest('/9.jpg', [-1, 1, 0])
	meshes[12] = matCapTest('/9.jpg', [-1, 1, 0])
