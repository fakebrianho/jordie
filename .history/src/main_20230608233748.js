...
function animate() {
	...
	meshes[2].material.uniforms.uTime.value += 0.33
	...
	meshes[7].material.uniforms.uTime.value += 0.33
	meshes[8].material.uniforms.uTime.value += 0.41
	meshes[9].material.uniforms.uTime.value += 0.11
	meshes[10].material.uniforms.uTime.value += 0.32
	meshes[11].material.uniforms.uTime.value += 0.21
	meshes[12].material.uniforms.uTime.value += 0.33
