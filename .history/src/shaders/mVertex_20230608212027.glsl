...
float windFrequency = uFreq; // controls how frequently the wind "blows"  
...
void main(){
  ...
  // Calculate the distance between each face's centroid and a vec3(0.0, e_EffectProgress, 0.0) vector,
    ...
    localPos.z  += noise(noisePos) * uWindStrength * noiseStrength; 
    localPos.y -= uWindStrength * sin(windFrequency * position.x + uTime * 0.5);
