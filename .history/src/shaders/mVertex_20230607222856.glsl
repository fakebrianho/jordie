...
void main(){
  ...
  vec3 noisePos = vec3(tPos.x * windFrequency + uTime * 0.4, tPos.y, tPos.z);
  tPos.z += noise(noisePos) * windStrength * noiseStrength;
  tPos.y -=  windStrength * sin( windFrequency * tPos.x + uTime * 0.5);
