...
function f2() {
	...
	f1(() => {
		sheet.sequence.attachAudio({ source: '/jordan.mp3' }).then(() => {
			...
			gsap.to('#J', { opacity: 0, duration: 2 })
			gsap.to('#O', { opacity: 0, duration: 2, delay: 1 })
			gsap.to('#R', { opacity: 0, duration: 2, delay: 2 })
			gsap.to('#D', { opacity: 0, duration: 2, delay: 3 })
			gsap.to('#I', { opacity: 0, duration: 2, delay: 4 })
			gsap.to('#E', { opacity: 0, duration: 2, delay: 5 })
		})
	})
}
