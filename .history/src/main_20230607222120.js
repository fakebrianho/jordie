...
function init() {
	...
	meshes.mat = matCapTest(textures)
...
function loadTextures() {
	...
	const t = loader.load('/noise.png')
	const matcapA = loader.load('/mc1.png')
	const matcapB = loader.load('/mc2.png')
	// const [matcapA, matcapB] = loader.load(['/mc1.png', '/mc2.png'])
	return { texture: t, m1: matcapA, m2: matcapB }
}
...
function initPost() {
	...
	selectedObjects.add(meshes.mat)
	selectiveBloom.selection = selectedObjects
	// bloomPass.luminancePass = true
...
function animate() {
	...
	if (meshes.mat.material.uniforms.u_EffectProgress < 2) {
		meshes.mat.material.uniforms.u_EffectProgress += 0.01
	}
